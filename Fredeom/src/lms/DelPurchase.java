...
public class DelPurchase extends JFrame implements ActionListener{
	    ...
	    public void actionPerformed(ActionEvent evt)
	    {
	        ...
	        {
	        	setVisible(false);
	            PurchaseMenu d=new PurchaseMenu();
	        ...
	        {
	        	setVisible(false);
	            DelSpecificPurchaseItem d=new DelSpecificPurchaseItem();
	        }
	    }
	}
